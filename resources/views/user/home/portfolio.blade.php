@php
    $allportfolios = App\Models\Portfolio::latest()->get();
    $websiteportfolios = App\Models\Portfolio::where('type', 'website')
        ->latest()
        ->get();
    $moblileappportfolios = App\Models\Portfolio::where('type', 'Mobile App')
        ->latest()
        ->get();
    $dashbboardportfolios = App\Models\Portfolio::where('type', 'Dashboard')
        ->latest()
        ->get();
    $landingpageportfolios = App\Models\Portfolio::where('type', 'Landing Page')
        ->latest()
        ->get();
    $brandingportfolios = App\Models\Portfolio::where('type', 'Brading')
        ->latest()
        ->get();
    $graphicdesignportfolios = App\Models\Portfolio::where('type', 'Graphic Design')
        ->latest()
        ->get();

    // dd($moblileappportfolio);
                            ...
                            @foreach ($allportfolios as $item)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ !empty($item->image) ? url($item->image) : url('no_image.jpg') }}"
                                            alt="">
                                    </div>
        ...
        <div class="tab-pane" id="website" role="tabpanel" aria-labelledby="website-tab">
            <div class="container">
                <div class="row gx-0 justify-content-center">
                    <div class="col">
                        <div class="portfolio__active">
                            @foreach ($websiteportfolios as $item)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ !empty($item->image) ? url($item->image) : url('no_image.jpg') }}"
                                            alt="">
        ...
        <div class="tab-pane" id="apps" role="tabpanel" aria-labelledby="apps-tab">
            <div class="container">
                <div class="row gx-0 justify-content-center">
                    <div class="col">
                        <div class="portfolio__active">
                            @foreach ($moblileappportfolios as $item)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ !empty($item->image) ? url($item->image) : url('no_image.jpg') }}"
                                            alt="">
        ...
        <div class="tab-pane" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
            <div class="container">
                <div class="row gx-0 justify-content-center">
                    <div class="col">
                        <div class="portfolio__active">
                            @foreach ($dashbboardportfolios as $item)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ !empty($item->image) ? url($item->image) : url('no_image.jpg') }}"
                                            alt="">
        ...
        <div class="tab-pane" id="landing" role="tabpanel" aria-labelledby="landing-tab">
            <div class="container">
                <div class="row gx-0 justify-content-center">
                    <div class="col">
                        <div class="portfolio__active">
                            @foreach ($landingpageportfolios as $item)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ !empty($item->image) ? url($item->image) : url('no_image.jpg') }}"
                                            alt="">
        ...
        <div class="tab-pane" id="branding" role="tabpanel" aria-labelledby="branding-tab">
            <div class="container">
                <div class="row gx-0 justify-content-center">
                    <div class="col">
                        <div class="portfolio__active">
                            @foreach ($brandingportfolios as $item)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ !empty($item->image) ? url($item->image) : url('no_image.jpg') }}"
                                            alt="">
        ...
        <div class="tab-pane" id="graphic" role="tabpanel" aria-labelledby="graphic-tab">
            <div class="container">
                <div class="row gx-0 justify-content-center">
                    <div class="col">
                        <div class="portfolio__active">
                            @foreach ($graphicdesignportfolios as $item)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ !empty($item->image) ? url($item->image) : url('no_image.jpg') }}"
                                            alt="">
